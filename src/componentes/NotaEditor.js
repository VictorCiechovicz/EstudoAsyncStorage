...
console.log(novaNota)
  await AsyncStorage.setItem(novaNota.id,novaNota.texto)
  mostraNotas()
}
  //=====Funçao para gerar um id dinamico de acordo com o salvamento de novas notas========//
